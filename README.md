# A Deep Understanding of Deep Learning — Notes & Code (Udemy Course)
...
My goal is to build a strong, intuitive understanding of deep learning — not just how to use the APIs, but *why* things work the way they do, the math behind the models, and how to reason about architectures, optimization, and training dynamics.
...
### **3️⃣ Regularization & Metaparameters**
...
### **4️⃣ Feedforward Networks & Data Handling**
- FFN architecture  
- MNIST experiments  
...
### **5️⃣ Weight Initialization & Autoencoders**
...
### **6️⃣ Convolutional Neural Networks (CNNs)**
...
### **1️⃣1️⃣ Ethics of Deep Learning**
- Bias, accountability, job impact  
- Real-world case studies  

### **1️⃣2️⃣ Python Foundations (Optional Section)**
...
Feel free to **star** ⭐ the repo or follow along with the course yourself!
